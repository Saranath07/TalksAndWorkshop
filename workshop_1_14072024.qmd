...
:::{.fragment .absolute left=100px top=200px}
$\downarrow$
:::
...
:::{.fragment .absolute left=100px bottom=200px}
$\downarrow$
:::
...
:::{.fragment .absolute right=0px top=50px}
:::{style="width:500px; height:500px"}
![](MedicalData.webp)
:::
:::

:::{.fragment .absolute right=0px bottom=50px}
```
Medical Data should be more 
protected as it might lead 
to various problems if leaked
```
:::
...
<video width="800" controls>
  <source src="Deep Fake Video Sample, Speech By Obama.mp4" type="video/mp4">
  Your browser does not support the video tag.
</video>
...
::: {style="margin-top: 0px; font-size: 2em;" }
**Though this looks realistic, this is not real.**
:::

:::{.fragment}
:::{style="width:700px; height:700px"}
![](DeepFakeRatanTata.png)
:::
:::

## Some problems which AI did not solve yet!! 
(Atleast till now)

:::{.fragment .absolute left=0px}
:::{style="width:700px; height:700px"}
![](ArcPrize.png)
:::
:::

:::{.fragment .absolute right=0px top=300px}
[Game Link](https://arcprize.org/play?task=00576224){preview-link="false"}
:::
...
:::{.non-incremental}
- [Mr. Arun Prakash - AI4Bharat](https://iitm-pod.slides.com/arunprakash_ai)
- [ACM India - Responsible AI](https://precogatiiit.notion.site/ACM-India-Summer-School-on-Responsible-Safe-AI-76108c53564d4dc4af46c1d3bed52946)
- [IBM Youtube](https://www.youtube.com/watch?v=QzY57FaENXg)
:::